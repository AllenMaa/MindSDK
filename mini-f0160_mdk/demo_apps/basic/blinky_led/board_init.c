...
void leds_init(void)
{
    ...
    gpio_init.Pins = GPIO_PIN_9 | GPIO_PIN_8 | GPIO_PIN_7 | GPIO_PIN_6;
    gpio_init.PinMode = GPIO_PinMode_Out_PushPull;
    gpio_init.Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOC, &gpio_init);
    GPIO_WriteBit(GPIOC, gpio_init.Pins, 1u);
    GPIO_PinAFConf(GPIOC, gpio_init.Pins, GPIO_AF_15); /* disable the alternative functions. */
}

void leds_on(void)
{
    uint16_t pins = GPIO_PIN_9 | GPIO_PIN_8 | GPIO_PIN_7 | GPIO_PIN_6;
    GPIO_WriteBit(GPIOC, pins, 0u);
}

void leds_off(void)
{
    uint16_t pins = GPIO_PIN_9 | GPIO_PIN_8 | GPIO_PIN_7 | GPIO_PIN_6;
    GPIO_WriteBit(GPIOC, pins, 1u);
}
