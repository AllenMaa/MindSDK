...
#define BOARD_SPI_MASTER_PORT          SPI1
#define BOARD_SPI_MASTER_BAUDRATE      400000u /* 400khz. */
#define BOARD_SPI_MASTER_FREQ          CLOCK_APB1_FREQ

/* DMA for SPI_XFER. */
#define BOARD_SPI_XFER_DMA_PORT        DMA1
#define BOARD_SPI_TX_DMA_CHANNEL       DMA_REQ_DMA1_SPI1_TX
#define BOARD_SPI_RX_DMA_CHANNEL       DMA_REQ_DMA1_SPI1_RX
#define BOARD_SPI_XFER_DMA_IRQ         DMA1_CH3_CH2_IRQn
#define BOARD_DMA_SPI_XFER_IRQHandler  DMA1_CH3_CH2_IRQHandler
