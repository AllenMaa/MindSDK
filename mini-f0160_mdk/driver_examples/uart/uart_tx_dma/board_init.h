...
#define BOARD_DMA_UART_TX_CHANNEL     DMA_REQ_DMA1_UART2_TX_1
#define BOARD_DMA_UART_TX_IRQn        DMA1_CH7_CH4_IRQn
#define BOARD_DMA_UART_TX_IRQHandler  DMA1_CH7_CH4_IRQHandler
