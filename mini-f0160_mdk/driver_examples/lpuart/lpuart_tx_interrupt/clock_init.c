...
void BOARD_InitBootClocks(void)
{
    ...
    RCC_ResetAPB1Periphs(RCC_APB1_PERIPH_PWR);

    /* BKP. */
    RCC_EnableAPB1Periphs(RCC_APB1_PERIPH_BKP, true);
    RCC_ResetAPB1Periphs(RCC_APB1_PERIPH_BKP);

    /* LPUART. */
    RCC_EnableAPB2Periphs(RCC_APB2_PERIPH_LPUART, true);
    RCC_ResetAPB2Periphs(RCC_APB2_PERIPH_LPUART);

    /* Enable LPUART LSE clock. */
    CLOCK_LPUARTLSE();
}
...
void CLOCK_LPUARTLSE(void)
{
    ...
    while (0u == (RCC_BDCR_LSERDY_MASK & RCC->BDCR) )
    {
    }
}
