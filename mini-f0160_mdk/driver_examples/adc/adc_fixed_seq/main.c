...
int main(void)
{
    ...
    while (1)
    {
        ...
        printf("fixed_seq conversion start...\r\n");
        ...
        printf("fixed_seq conversion done...\r\n");
    }
}
...
void app_adc_init(void)
{
    ...
    /* setup the conversion fixed sequence channel. */
    ...
    for (uint32_t i = 0; i < APP_ADC_SEQ_LEN; i++)
    {
        ...
        ADC_EnableSeqSlotFixed(BOARD_ADC_PORT, slots, ADC_SeqFixedDirection_LowFirst);
